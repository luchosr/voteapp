<template>
  <div class="posts">
    <h1>Elección de barba 2020</h1>
    <h3>Si ya estás registrado, ingresa tu ID por favor</h3>
    <!--span><b>{{ response }}</b></span><br /-->
    <form v-on:submit="validateVoter">
      <input type="text" v-model="loginData.voterId" placeholder="ID de votante">
      <br>
    ...
    <br>
    <h3>De otra manera, llena el formulario para registrarte!</h3>
    <form v-on:submit="registerVoter">
      <input type="text" v-model="registerData.voterId" placeholder="ID de votante">
      <br>
      <input type="text" v-model="registerData.registrarId" placeholder="Área de trabajo">
      <br>
      <input type="text" v-model="registerData.firstName" placeholder="Nombre">
      <br>
      <input type="text" v-model="registerData.lastName" placeholder="Apellido/s">
      <br>
